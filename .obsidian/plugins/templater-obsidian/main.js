...
> \u2014 ${o}`;
        ...
        return (
          new O("Error generating daily quote"), "Error generating daily quote"
        );
      }
    };
  }
...
var kn = class {
  constructor(e) {
    this.plugin = e;
    (this.functions_generator = new _i(this.plugin)), (this.parser = new vi());
  }
  async setup() {
...
var Qo = X(require("@codemirror/language")),
  ...
  Ni = class {
    constructor(e) {
      this.plugin = e;
      (this.cursor_jumper = new Ei(e.app)), (this.activeEditorExtensions = []);
    }
        ...
        let i = {
          ...
          token: function (o, a) {
            ...
            if (l != null) {
              ...
              return (
                (a.inCommand = !0), `line-${Pi} ${Di} ${Zs} ${a.tag_class}`
              );
            }
